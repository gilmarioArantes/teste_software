    try {
var _mN = _mN || {};
var iframeURL = 'https://contextual.media.net/mediamain.html?cid=8CUQBB2U5&cpcd=7xRa5ccNXLLzdohX57nd7w%3D%3D&crid=441289839&pid=8PO56711S&size=641x481&https=1&cpnet=yVb1sHm-0KIh29BOFTjjrDpxjZWX6ciQr11kVPXNdQE%3D&cme=e9kSeFpC_wTof47O3dVinVJA5OkOPo7xy7LDDxQWY1j7OSAKnkDZyDOrmCpC43dI1vwo1OJKxz5QfDzFUdDvIA5V3j-lyaQ652U8Y1zO5xFPC4SpUok_cjxAWJ_E3sy3k_iTAZ9pfrM%3D%7C%7CNDHRnZ9Gz3KXlI-i9OnZqQ%3D%3D%7C5gDUJdTGiJzedmq9hanWYg%3D%3D%7CN7fu2vKt8_s%3D%7CYAOvQ_Ze0OgBPuNng1SNnRe5eTBNsTk21hvEPODGG8Aqvfn0ZSiC_fhG9_hQNUSBwT9mHQMZoLI8oWv28djhBg%3D%3D%7Cy2SqoJcE0s9nfXn920_qJVmRoxhLPTa3-yxAj0rmay8%3D%7C&cc=BR&bf=0&vif=0&ugd=4&nse=3';
iframeURL += "&vi=1554991757691821935";var winScope = window;var vi = '1554991757691821935';var viComp = '1554991314218174273';_mNDetails = (typeof _mNDetails != "undefined")?_mNDetails:{};var _mNObject = window._mN;
...
_mNDetails.amendToLocHash('&l2ch='+l2ch);            _mNDetails.amendToLocHash('&l2wsip=2886939440');if (_mNDetails && _mNDetails._mNABP && _mNDetails._mNABP.domAbpDetect && _mNDetails._mNABP.domAbpDetect === 1) {
...
!function(t,e,n,i,o){function s(e){a=!1,e=e?e:t.event,e.clientY<30&&(a=!0)}function m(e){e=e?e:t.event;var o=e.relatedTarget||e.toElement;if((!o||"HTML"==o.nodeName)&&e.clientY<10&&a){var s=d();(!i.exTrgTm||s-u>=i.exTrgTm)&&n.exInttAd.show()}}function c(n){this.cont=n,this.cont.style.display="none",this.cont.style.position="CSS1Compat"==e.compatMode?"fixed":"absolute",this.cont.style.left=t._mNInslLeftPx||"5px",this.cont.style.top=t._mNInslTopPx||"5px",this.cont.allowTransparency=this.chkVd(),this.cont.height=t._mNInslHeightPer||"99%",this.cont.width=t._mNInslWidthPer||"99%",this.cont.style.cssText=this.cont.style.cssText+";z-index:2147483647 !important;",this.atevL()}function r(){var o=this.cont.contentWindow||this.cont.contentDocument;this.cont.style.display="block",this.timer(this.timerVal),t.waitForEInsl[i.crid]=!1,o&&o.mUtil&&(o.mUtil.renderAdUnit(),l(),n.eventLib.removeEvent(e,"mouseout",n.exInttAd.checkMousePointer),/msie/.test(h)&&n.eventLib.removeEvent(e,"mousemove",n.exInttAd.mouseMoveDirection),_mNDetails._mNVI.trigger(this.cont),o._mNL3&&o._mNL3.vi&&_mNDetails.triggerAdTagEvent(o._mNL3.vi,"VIMP::Detect",!0,{targetElement:this.cont.id,type:"insl",inslWinScope:o}))}function l(){var t=1,e="_mNExInsl",n=i.tm,o=i.dm;if(i.inslntdy){var s=_mN._util.mngc(e);s&&(s=parseInt(s),s++,t=s)}_mN.util.isStringSet(n)?_mN._util.mnsc(e,t,1,"/",o,"",n):_mN.util.isStringSet(o)?_mN._util.mnsc(e,t,1,"/",o):_mN._util.mnsc(e,t,1,"/")}function d(){return parseInt((new Date).getTime()/1e3,10)}var a=!0,h=t.navigator.userAgent.toLowerCase(),u=d();n.exInttAd&&!n.exInttAd.checkMousePointer&&(n.exInttAd.checkMousePointer=m,n.exInttAd.init=c,n.exInttAd.show=r,n.eventLib.addEvent(e,"mouseout",n.exInttAd.checkMousePointer),/msie/.test(h)&&(a=!1,n.exInttAd.mouseMoveDirection=s,n.eventLib.addEvent(e,"mousemove",n.exInttAd.mouseMoveDirection)))}(window,document,_mN_dy,exIntParams);        function isPreloadSupported(){
        ...
        if (_mNDetails && !_mNDetails.plnr && isPreloadSupported()) {
            ...
            if (headID && headID[0]) {
                ...
                link.rel = 'preload';
                link.href = 'https://contextual.media.net/__media__/js/util/nrrV7764.js';
                link.as = "script";
